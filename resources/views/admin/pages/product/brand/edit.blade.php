{{-- resources/views/admin/pages/product/brand/edit.blade.php --}}
...
<div class="page-heading">
    <div class="page-heading-copy">
        ...
        <div>
            ...
            <h1 class="h3 mb-1">Edit Product Brand</h1>
            <p class="text-muted mb-0">Update brand: <strong>{{ $brand->name }}</strong></p>
        </div>
    </div>
    <div class="heading-actions">
        <a class="btn btn-outline-secondary btn-sm" href="{{ route('admin.product.brand') }}">
...
<section class="row g-3">
    <div class="col-12 col-xl-8">
        <form class="panel" action="{{ route('admin.product.brand.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('name') is-invalid @enderror"
                           name="name" type="text" value="{{ old('name', $brand->name) }}"
                           required>
                    @error('name')
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input class="form-control @error('slug') is-invalid @enderror"
                               id="slug" name="slug" type="text" value="{{ old('slug', $brand->slug) }}"
                               required>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('sort_order') is-invalid @enderror"
                           name="sort_order" type="number" value="{{ old('sort_order', $brand->sort_order) }}"
                           min="0">
                    @error('sort_order')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-12">
                    ...
                    @if($brand->image)
                        <div class="mb-2 p-2 bg-light rounded">
                            <img src="{{ $brand->image_url }}" width="100" class="rounded" alt="{{ $brand->name }}">
                        </div>
                    @endif
            ...
            <div class="d-flex flex-wrap justify-content-end gap-2 mt-4">
                <a class="btn btn-outline-secondary" href="{{ route('admin.product.brand') }}">Cancel</a>
...
$(document).ready(function() {
    $('#generateSlug').on('click', function() {
        ...
        $.ajax({
            url: '{{ route("admin.product.brand.generate-slug") }}',
            type: 'POST',
