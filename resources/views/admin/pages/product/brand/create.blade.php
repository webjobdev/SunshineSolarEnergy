{{-- resources/views/admin/pages/product/brand/create.blade.php --}}
...
<div class="page-heading">
    <div class="page-heading-copy">
        ...
        <div>
            ...
            <h1 class="h3 mb-1">Create Product Brand</h1>
...
<section class="row g-3">
    <div class="col-12 col-xl-8">
        <form class="panel" action="{{ route('admin.product.brand.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="panel-header">
                <div>
                    ...
                    <p class="text-muted mb-0">Enter brand details.</p>
                </div>
            </div>
