...
<div class="page-heading">
    <div class="page-heading-copy">
        ...
        <div>
            ...
            <h1 class="h3 mb-1">Edit Product Category</h1>
            <p class="text-muted mb-0">Update category: <strong>{{ $category->name }}</strong></p>
        </div>
    </div>
...
<section class="row g-3">
    <div class="col-12 col-xl-8">
        <form class="panel" action="{{ route('admin.product.category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="panel-header">
                ...
                <div>
                    <span class="badge bg-light text-dark">
                        ...
                        Updated: {{ $category->updated_at->format('M d, Y H:i') }}
                    </span>
                </div>
            </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input class="form-control @error('slug') is-invalid @enderror"
                               id="slug" name="slug" type="text" value="{{ old('slug', $category->slug) }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('sort_order') is-invalid @enderror"
                           name="sort_order" type="number" value="{{ old('sort_order', $category->sort_order) }}" min="0">
                    @error('sort_order')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12">
                    ...
                    @if($category->image)
                        <div class="mb-2 p-2 bg-light rounded">
                            <img src="{{ $category->image_url }}" width="100" class="rounded" alt="{{ $category->name }}">
                        </div>
                    @endif
