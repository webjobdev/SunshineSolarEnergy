...
@push('styles')
    <style>
        ...
        .btn-filter-mobile .filter-badge:empty {
            display: none;
        }
    ...
    <script>
        ...
        window.ProductsFilter = (function () {
            ...
            function buildQuery(page) {
                ...
                // Sort — read from select (desktop or mobile)
            ...
            function init() {
                ...
                if (sort) {
                    sort.addEventListener('change', function () {
                        const mobileSortEl = document.getElementById('sortMobile');
                        if (mobileSortEl) mobileSortEl.value = this.value;
                        fetchProducts(null);
                    });
                }
                ...
                if (sortMobile) {
                    sortMobile.addEventListener('change', function () {
                        const desktopSortEl = document.getElementById('sort');
                        if (desktopSortEl) desktopSortEl.value = this.value;
                        fetchProducts(null);
                    });
                }
